// ============================================================
// 1. KONFIGURASI FIREBASE (DATA DARI CONSOLE LO)
// ============================================================
...
// ============================================================
// 2. VARIABEL GLOBAL (TETAP SEPERTI SEBELUMNYA)
// ============================================================
...
// ============================================================
// 3. LOGIKA REAL-TIME (BARU: NARIK DATA DARI TEMEN LO)
// ============================================================
// Fungsi ini otomatis jalan kalau ada temen lo yang kirim data lewat link
db.ref('onlineOrders').on('value', (snapshot) => {
    const val = snapshot.val();
    if (val) {
        // Gabungkan data dari Firebase ke dataOnline lokal
        dataOnline = Object.keys(val).map(key => ({
            ...val[key],
            firebaseId: key // Simpan ID Firebase biar bisa dihapus nanti
        }));
...
// Sync data laundry utama ke Cloud (Opsional: biar admin bisa liat di mana aja)
...
// ============================================================
// 4. FUNGSI LOGIKA (SEMUA LOGIKA LO TETAP ADA)
// ============================================================
...
function prosesOnline(id) {
    ...
    // Hapus dari Firebase juga setelah diproses
    if(order.firebaseId) {
...
function hapusSemuaRiwayat() {
    if(confirm("Hapus semua riwayat yang sudah SELESAI di Cloud?")) {
...
// Fungsi saveData diubah untuk render saja, karena update sudah lewat Firebase Listener
function saveData() { renderAll(); }
